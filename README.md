...
透過系統化與自動化方式提升工作效率、降低人為錯誤；同時建置歷年圖幅銷售與更新紀錄查詢功能，加速資料檢索。
### 功能概述   
1. 更新圖幅週報表  
...
#### 圖幅銷售數量查詢  
    功能說明:    
    1. 點選任意圖幅，即時查看該圖幅資訊與銷售量
    2. 以互動式地圖呈現各區域的圖幅銷售熱度，藉此了解不同地區之圖幅需求分布
...
```
### 未來改善方向
- 歷年圖幅銷售及更新資料查詢功能中，新增銷售報表匯入機制，並自動將資料寫入資料庫，以利資料持續累積與後續分析應用。

- 圖幅銷售數量查詢工具中，整合銷售與更新版次、日期等相關資訊，提供完整圖幅資訊，協助使用者進行整體判斷與決策。  
